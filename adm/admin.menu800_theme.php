...
$menu['menu800'] = array(
    ...
    array('800300', '온라인 문의 관리', G5_PLUGIN_URL . '/online_inquiry/adm/list.php', 'online_inquiry'),
    array('800350', '카피라이트관리', G5_PLUGIN_URL . '/copyright_manager/admin.php', 'copyright_manager'),
    array('800400', '지도 API 설정', G5_PLUGIN_URL . '/map_api/adm/config_form.php', 'map_api_config'),
    array('800500', '트리 카테고리 관리', G5_PLUGIN_URL . '/tree_category/admin.php', 'tree_category')
);
