...
<head>
    ...
    if (defined('_SHOP_'))
        $shop_css = '_shop';
    echo '<link rel="stylesheet" href="' . run_replace('head_css_url', G5_THEME_CSS_URL . '/' . (G5_IS_MOBILE ? 'mobile' : 'default') . $shop_css . '.css?ver=' . G5_CSS_VER . '_' . date('His_s_34') . '', G5_THEME_URL) . '">' . PHP_EOL;
    ?>
    <!--[if lte IE 8]>
...
<![endif]-->
    ...
    add_javascript('<script>document.addEventListener("DOMContentLoaded", function() { AOS.init({ duration: 800, once: true }); });</script>', 1);
