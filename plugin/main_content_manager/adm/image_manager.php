    ...
    <div class="content-wrapper">
        ...
        <div id="crop_interface">
            ...
            <div class="crop-footer">
                <span style="color:#aaa; font-size:12px; margin-right:15px; float:left; line-height:30px;">* 이미지 비율이
                    <?php echo $target_w > 0 ? $target_w . "x" . $target_h : "자유"; ?> 로 고정됩니다.
                </span>
    ...
    <script>
        ...
        function switchTab(tabName) {
            ...
            if (tabName == 'unsplash') {
                ...
                if (!unsplashLoaded) {
                    var url = '../../unsplash_api/popup.php?w=' + targetW + '&h=' + targetH + '&mi_id=' + mi_id;
        ...
        function selectImage(url) {
            ...
            if (targetWindow && targetWindow.receiveImageUrl) {
                targetWindow.receiveImageUrl(url, mi_id);
                if (window.opener) window.close();
                else if (targetWindow.closeUnsplashModal) targetWindow.closeUnsplashModal();
            } else {
                console.error("Parent callback not found");
            }
        }

        // Alias for compatibility with Unsplash API popup
        window.receiveUnsplashUrl = function (url, unused_mi_id) {
            selectImage(url);
        };
