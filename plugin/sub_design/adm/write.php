...
$row = array('sd_id' => '', 'sd_theme' => '', 'sd_lang' => 'kr', 'sd_skin' => 'standard', 'sd_layout' => 'full', 'sd_breadcrumb' => 0, 'sd_breadcrumb_skin' => 'dropdown', 'sd_menu_table' => '');
if ($w == 'u') {
...
$(function () {
    function load_menu_list() {
        ...
        $.post("./ajax.load_menus.php", { sd_id: sd_id, lang: lang, sd_menu_table: $("#sd_menu_table").val(), _t: new Date().getTime() }, function (data) {
