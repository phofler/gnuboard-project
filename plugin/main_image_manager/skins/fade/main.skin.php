                    ...
                    <div class="hero-content">
                        <div class="hero-content-inner">
                            ...
                            <?php if($slide['mi_link']) { ?>
                                <a href="<?php echo $slide['mi_link']; ?>" target="<?php echo $slide['mi_target']; ?>" class="hero-btn btn-animation"><?php echo !empty($slide['mi_btn_text']) ? stripslashes($slide['mi_btn_text']) : 'DISCOVER NOW'; ?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
