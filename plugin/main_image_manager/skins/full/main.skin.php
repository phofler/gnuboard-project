...
$effect = isset($hero_config['effect']) ? $hero_config['effect'] : 'fade';
...
add_stylesheet('<link rel="stylesheet" href="'.G5_PLUGIN_URL.'/main_image_manager/skins/full/style.css">', 10);
?>

<div class="hero-section hero-style-full" style="height: <?php echo $height; ?>;">
                    ...
                    <div class="hero-content">
                        <div class="hero-content-inner">
                            ...
                            <?php if($slide['mi_title']) { ?>
                                <h1 class="title-animation"><?php echo stripslashes($slide['mi_title']); ?></h1>
                            <?php } ?>
                            ...
                            <?php if($slide['mi_link']) { ?>
                                <a href="<?php echo $slide['mi_link']; ?>" target="<?php echo isset($slide['mi_target']) ? $slide['mi_target'] : '_self'; ?>" class="hero-btn btn-animation"><?php echo !empty($slide['mi_btn_text']) ? stripslashes($slide['mi_btn_text']) : 'VIEW GALLERY'; ?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
