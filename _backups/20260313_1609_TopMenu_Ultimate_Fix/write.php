...
<form name="fconfig" method="post" action="./update.php" enctype="multipart/form-data">
    ...
    <input type="hidden" name="tm_id_org" value="<?php echo $tm_id; ?>">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="margin-top:5px; padding:10px; background:#f9f9f9; border:1px solid #eee;">
                            ...
                            <?php if ($w == 'u') { ?>
                                <div style="color:blue; font-size:11px; margin-top:5px;">* 수정 모드에서는 식별코드를 변경할 수 없습니다.</div>
                            <?php } ?>
                        </div>
                        ...
                        <script>
                            function generate_tm_id() {
                                if ("<?php echo $w; ?>" == "u") return; // 수정 모드 시 실행 차단
