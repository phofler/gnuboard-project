...
<section class="main-items">
    <div class="container">
        ...
        <div class="items-grid">
            <div class="item-card reveal slide-up" style="transition-delay: 0.1s;">
                <div class="img-box"><img src="<?php echo G5_THEME_URL ?>/1.jpg" alt="메탈패널"></div>
                <div class="info">
                    <h4>메탈 패널</h4>
                </div>
            </div>
            <div class="item-card reveal slide-up" style="transition-delay: 0.2s;">
                <div class="img-box"><img src="<?php echo G5_THEME_URL ?>/1.jpg" alt="우레탄패널"></div>
                <div class="info">
                    <h4>우레탄 패널</h4>
                </div>
            </div>
            <div class="item-card reveal slide-up" style="transition-delay: 0.3s;">
                <div class="img-box"><img src="<?php echo G5_THEME_URL ?>/1.jpg" alt="징크패널"></div>
                <div class="info">
                    <h4>징크 패널</h4>
                </div>
            </div>
            <div class="item-card reveal slide-up" style="transition-delay: 0.4s;">
                <div class="img-box"><img src="<?php echo G5_THEME_URL ?>/1.jpg" alt="데크패널"></div>
                <div class="info">
                    <h4>데크 패널</h4>
                </div>
            </div>
...
<section class="bottom-links">
    <div class="container">
        <div class="links-grid">
            ...
            <a href="/board.php?t=board&cd=news" class="link-box reveal slide-up" style="transition-delay: 0.3s;">
                <h4>공지사항</h4>
                <p>성우첨단패널의 새로운</p>
                <p>소식을 확인하세요.</p>
            </a>
...
<script>
    $(function() {
        ...
        // Slider switch (if multiple slides exist)
        let cur = 0;
        const slides = $('.slide');
        if (slides.length > 1) {
            setInterval(() => {
