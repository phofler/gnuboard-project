...
// [Dynamic Menu] pro_menu_manager 연동
...
<header id="mainHeader" class="header">
    <div class="gnbWrapBg">
        <div class="container gnbArea">
            ...
            <h1 class="logo"><a href="<?php echo G5_URL ?>"><img src="<?php echo G5_THEME_URL ?>/m_logo.png" alt="성우첨단패널 로고"></a></h1>
            <nav>
                <ul class="gnb" id="gnb">
                    <?php
                    if (function_exists('get_pro_menu_list')) {
                        ...
                        foreach ($menu_tree as $root) {
                            $active_class = (defined('_INDEX_') && $i == 1) ? '' : ''; // 필요시 제어
                    ?>
...
<div class="m-menu-wrap">
    <div class="m-menu-header">
        <div class="m-logo-area">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_THEME_URL ?>/m_logo.png" alt="성우첨단패널 로고"></a>
        </div>
