...
function display_footer_info($cp_id = '')
{
    ...
    if (function_exists('set_pro_skin_context')) {
        set_pro_skin_context(array(
            ...
            'txt_company' => $cp['company_val'],
            'txt_ceo' => $cp['ceo_val'],
            'txt_bizno' => $cp['bizno_val']
        ));
    }
    ...
    // Process Content Substitution (Placeholder Expansion)
    ...
    $replacements = array(
        ...
        '{company}' => $cp['company_val'],
        '{ceo}' => $cp['ceo_val'],
        '{bizno}' => $cp['bizno_val'],
        '{company_name}' => $cp['company_label'],
        '{ceo_name}' => $cp['ceo_label'],
        '{bizno_name}' => $cp['bizno_label'],
