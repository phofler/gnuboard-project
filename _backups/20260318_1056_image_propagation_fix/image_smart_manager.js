...
var SmartImageManager = {
    ...
    /**
     * Unsplash 팝업 열기
     * @param {Object} options { id, index, callback, fallbackW, fallbackH }
     */
    ...
    /**
     * 실제 팝업 호출 (경로는 모듈 위치에 따라 유연하게 처리 필요)
     */
    ...
    receive: function(url) {
        ...
        if (this.callback && typeof this.callback === 'function') {
            this.callback(url, this.targetId, this.targetIndex);
            return;
        }
