                            ...
                            <div style="display:flex; gap:20px;">
                                <div style="width:200px;">
                                    ...
                                    <div class="img-mgr-btns">
                                        <button type="button" class="btn btn_03" onclick="SmartImageManager.open({id:'mc_preview_<?php echo $mi_id; ?>', index: -1, callback: function(url){ receiveImageUrl(url, '<?php echo $mi_id; ?>'); } });">이미지 변경</button>
