...
if (!$skin_name || $skin_name == 'theme/basic' || $skin_name == 'basic')
    $skin_name = 'type_a';

$skin_file = G5_PLUGIN_PATH . '/company_intro/skin/' . $skin_name . '.html';

// [Fix] Final check: if file STILL doesn't exist (e.g. invalid string from DB), fallback to default type_a
if (!file_exists($skin_file)) {
    $skin_file = G5_PLUGIN_PATH . '/company_intro/skin/type_a.html';
}
...
if (file_exists($skin_file)) {
    ...
    $fidelity_filters = array(
        ...
        '#FF3B30' => 'var(--edge-color)',
        '#c92127' => 'var(--edge-color)',
...
$bg_color = (isset($co_row['co_bgcolor']) && $co_row['co_bgcolor'] && $co_row['co_bgcolor'] != '#000000' && $co_row['co_bgcolor'] != '#121212' && $co_row['co_bgcolor'] != '#e8e8e8') ? $co_row['co_bgcolor'] : '';
?>