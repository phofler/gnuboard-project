...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div id="crop_interface">
            ...
            <div class="crop-footer">
                <span style="color:#888; font-size:11px;">* 비율:
                    <?php echo $target_w > 0 ? $target_w . "x" . $target_h : "자유"; ?> 고정</span>
    ...
    <div class="mgr-footer">
        <div class="target-info">
            ...
            현재 선택 영역 크기: <?php if ($target_w > 0) { ?><b><?php echo $target_w ?> x
                    <?php echo $target_h ?></b><?php } else { ?><b>자유</b><?php } ?>
        </div>
    ...
    <script>
        ...
        function switchTab(tab) {
            ...
            if (tab == 'unsplash') {
                ...
                if (!unsplashLoaded) { $('#unsplash_iframe').attr('src', '../../unsplash_api/popup.php?w=' + targetW + '&h=' + targetH); unsplashLoaded = true; }
            }
