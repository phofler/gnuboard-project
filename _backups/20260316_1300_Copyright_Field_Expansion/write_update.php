...
$sql_common = " cp_subject = '" . addslashes(stripslashes($_POST['cp_subject'])) . "',
                logo_url = '" . addslashes(stripslashes($logo_url)) . "',
                slogan = '" . addslashes(stripslashes($_POST['slogan'])) . "',
                addr_label = '" . addslashes(stripslashes($_POST['addr_label'])) . "',
                addr_val = '" . addslashes(stripslashes($_POST['addr_val'])) . "',
                tel_label = '" . addslashes(stripslashes($_POST['tel_label'])) . "',
                tel_val = '" . addslashes(stripslashes($_POST['tel_val'])) . "',
                fax_label = '" . addslashes(stripslashes($_POST['fax_label'])) . "',
                ...
                link2_url = '" . addslashes(stripslashes($_POST['link2_url'])) . "',
                copyright = '" . addslashes(stripslashes($_POST['copyright'])) . "',
                cp_content = '" . addslashes(stripslashes($_POST['cp_content'])) . "',
                cp_skin = '" . addslashes(stripslashes($_POST['cp_skin'])) . "',
                cp_bgcolor = '" . addslashes(stripslashes($_POST['cp_bgcolor'])) . "',
