...
<style>
    ...
    @media (max-width: 1024px) {
        .sub-hero-cinema .sub-hero-title { font-size: 4rem; }
    }

    @media (max-width: 768px) {
        .sub-hero-cinema .sub-hero-title { font-size: 2.5rem; }
        .sub-hero-cinema .sub-hero-tag { font-size: 0.9rem; letter-spacing: 0.3em; }
        .sub-hero-cinema .sub-hero-subtitle { font-size: 1rem; letter-spacing: 0.2em; }
    }
</style>