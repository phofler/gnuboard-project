...
<div class="main-slider">
    <div class="slide active">
        <div class="slide-bg" style="background-image: url('<?php echo G5_THEME_IMG_URL ?>/Gemini_Generated_Image_h8tejph8tejph8te.jpg');"></div>
    ...
    <div class="container">
        ...
        <div class="product-row">
            ...
            <div class="product-img reveal slide-right">
                <img src="<?php echo G5_THEME_IMG_URL ?>/glasswool_p.png" alt="그라스울 패널">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="links-grid">
            <div class="link-box customer-center-box reveal slide-up" style="transition-delay: 0.1s;">
                ...
                <ul class="cc-info-list">
                    <li><i class="fa-regular fa-clock"></i> <span>평 일 AM 08:30 ~ PM 18:00</span></li>
