...
<div class="sub-layout-width-height">
    <div id="bo_list">
        ...
        <!-- Theme Standardization: Dataroom Header (Left Aligned) -->
        <div class="section-header" data-aos="fade-right">
            <p style="color:var(--color-accent-gold); font-weight:bold; letter-spacing:1px; margin-bottom:10px;">DATA
                CENTER</p>
            <h2 style="font-size:3rem; margin-bottom:0; text-transform:uppercase;"><?php echo $board['bo_subject'] ?>
            </h2>
            <p style="color:var(--color-text-secondary); margin-top:20px; font-weight:normal;">다양한 자료와 정보를 공유하는 공간입니다.
            </p>
        </div>
    ...
    <?php if ($is_checkbox) { ?>
        <script>         function all_checked(sw) {
